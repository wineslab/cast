...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rx_gain_slider = rx_gain_slider = 15
        ...
        # Blocks
        ##################################################
        self._rx_gain_slider_range = Range(0, 37.5, 0.5, 15, 200)
        self._rx_gain_slider_win = RangeWidget(self._rx_gain_slider_range, self.set_rx_gain_slider, 'rx_gain_slider', "counter_slider", float)
        self.top_grid_layout.addWidget(self._rx_gain_slider_win)
        ...
        self.uhd_usrp_source_0.set_gain(rx_gain_slider, 0)
    ...
    def get_rx_gain_slider(self):
        return self.rx_gain_slider

    def set_rx_gain_slider(self, rx_gain_slider):
        self.rx_gain_slider = rx_gain_slider
        self.uhd_usrp_source_0.set_gain(self.rx_gain_slider, 0)
